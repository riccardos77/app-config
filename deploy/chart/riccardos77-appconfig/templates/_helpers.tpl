...
app.kubernetes.io/name: {{ include "app-config.fullname" . }}
...
{{- define "image" -}}
{{- if .Values.image.dev -}}
  {{ .Values.image.imageName }}:{{ .Values.image.tag }}
{{- else -}}
  {{ .Values.global.repository}}{{ .Values.image.imageName }}:{{ .Values.image.tag | default .Chart.AppVersion }}
{{- end -}}
{{- end -}}
